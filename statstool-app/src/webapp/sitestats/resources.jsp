...
<sakai:view title="#{msgs.tool_title}">
	...
	<style type="text/css">
		...
		<h3><h:outputText value="#{msgs.menu_resources}" rendered="#{BaseBean.allowed}"/></h3>
	...
	<t:div style="width:100%">		
		<t:dataTable
			...
			<h:column>
		        ...
		        <h:outputText value="#{ResourcesBean.userNames[row.userId]}"/>
			</h:column>
			<h:column>
				<f:facet name="header">
