...
public class VBarChartTag extends UIComponentTag {
	...
	public Integer  weekOfYear	= null;
	public String  weekOfYearStr	= null;

	// Associate the renderer and component type.
	public String getComponentType() {
		return "edu.ufp.sakai.jsf.VBarChart";
	}
	...
	protected void setProperties(UIComponent component) {
		...
		// weekOfYear
		if (isValueReference(weekOfYearStr)) {
            ValueBinding vb=context.getApplication().createValueBinding(weekOfYearStr);
            if(vb!=null){
            	weekOfYear = (Integer) vb.getValue(context);
                component.setValueBinding("weekOfYear", vb);
            }else component.getAttributes().put("weekOfYear", weekOfYear);
        } else {
            throw new NullPointerException();
        }	
	}
